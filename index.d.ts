...
declare module 'jpf' {
    import * as types from "jpf/Types";
    import { Style } from "jpf/Style";
    export class FrameworkElement {
        ...
        deleteStyle(style: types.CssProperties | Array<types.CssProperties>): void;
        element: HTMLElement;
        id: string;
        type: string;
