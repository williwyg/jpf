...
/***/ "./src/framework/childrensUiElement.ts":
/*!*********************************************!*\
  !*** ./src/framework/childrensUiElement.ts ***!
  \*********************************************/
/*! no static exports found */
...
"use strict";
eval("\r\nvar __extends = (this && this.__extends) || (function () {\r\n    var extendStatics = function (d, b) {\r\n        extendStatics = Object.setPrototypeOf ||\r\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\r\n            function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };\r\n        return extendStatics(d, b);\r\n    };\r\n    return function (d, b) {\r\n        extendStatics(d, b);\r\n        function __() { this.constructor = d; }\r\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\r\n    };\r\n})();\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nvar ko = __webpack_require__(/*! knockout */ \"knockout\");\r\nvar uiElement_1 = __webpack_require__(/*! ./uiElement */ \"./src/framework/uiElement.ts\");\r\nvar ChildrensUiElement = (function (_super) {\r\n    __extends(ChildrensUiElement, _super);\r\n    function ChildrensUiElement(tagName, type, options) {\r\n        var _this = _super.call(this, tagName, type, options) || this;\r\n        var children = _this.options.children;\r\n        if (ko.isObservable(children)) {\r\n            children.subscribe(function () {\r\n                _this.renderChildren();\r\n            });\r\n        }\r\n        return _this;\r\n    }\r\n    ChildrensUiElement.prototype.renderChildren = function () {\r\n        if (this.element) {\r\n            while (this.element.firstChild) {\r\n                this.element.removeChild(this.element.firstChild);\r\n            }\r\n            if (this.options.children) {\r\n                var documentFragment = document.createDocumentFragment();\r\n                for (var _i = 0, _a = ko.unwrap(this.options.children); _i < _a.length; _i++) {\r\n                    var child = _a[_i];\r\n                    documentFragment.appendChild(child.render());\r\n                }\r\n                this.element.appendChild(documentFragment);\r\n            }\r\n        }\r\n    };\r\n    ChildrensUiElement.prototype.build = function () {\r\n        _super.prototype.build.call(this);\r\n        this.renderChildren();\r\n    };\r\n    ChildrensUiElement.prototype.getChildren = function () {\r\n        return ko.unwrap(this.options.children);\r\n    };\r\n    ChildrensUiElement.prototype.setChildren = function (children) {\r\n        this.options.children = children;\r\n        this.renderChildren();\r\n    };\r\n    ChildrensUiElement.prototype.addChild = function (newChild, referenceChild) {\r\n        if (referenceChild) {\r\n            var index = this.options.children.indexOf(referenceChild);\r\n            if (index > -1) {\r\n                this.options.children.splice(index, 0, newChild);\r\n                if (this.element && referenceChild.getElement()) {\r\n                    this.element.insertBefore(newChild.render(), referenceChild.getElement());\r\n                }\r\n            }\r\n        }\r\n        else {\r\n            this.options.children.push(newChild);\r\n            if (this.element) {\r\n                this.element.appendChild(newChild.render());\r\n            }\r\n        }\r\n    };\r\n    ChildrensUiElement.prototype.removeChild = function (element) {\r\n        var index = this.options.children.indexOf(element);\r\n        if (index > -1) {\r\n            this.options.children.splice(index, 1);\r\n            if (this.element) {\r\n                this.element.removeChild(this.element.children[index]);\r\n            }\r\n        }\r\n    };\r\n    ChildrensUiElement.prototype.clear = function () {\r\n        var children = this.options.children;\r\n        if (ko.isObservable(children)) {\r\n            children([]);\r\n        }\r\n        else {\r\n            this.options.children = [];\r\n            if (this.element) {\r\n                while (this.element.firstChild) {\r\n                    this.element.removeChild(this.element.firstChild);\r\n                }\r\n            }\r\n        }\r\n    };\r\n    return ChildrensUiElement;\r\n}(uiElement_1.UiElement));\r\nexports.ChildrensUiElement = ChildrensUiElement;\r\n\n\n//# sourceURL=webpack://jpf/./src/framework/childrensUiElement.ts?");
